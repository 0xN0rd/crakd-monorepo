...
import { CloseIcon, SuccessIcon, GoogleIcon, FacebookIcon } from '../../ui/icons';
        ...
        return (
            <div>
                ...
                <Container centered padding="lg">
                    <Empty>
                        <div>There are no users yet. Kekw.</div>
                    </Empty>
                </Container>
            </div>
        );
                    ...
                    <SearchContainer>
                        <Form onSubmit={onSearchFormSubmit}>
                            <SearchInput
                                ...
                                type="text"
                                value={searchValue}
                                placeholder="Search by email, name, gamertag, or username"
                            />
                            {searchQuery && (
                                            ...
                                            {users?.map((user: any) => (
                                                <Tr bgColor={user.banned ? 'error' : ''} key={user._id} title="Banned">
                                                    ...
                                                    <Td>
                                                        ...
                                                        {user.googleId && <GoogleIcon width="14" />}
                                                    </Td>
