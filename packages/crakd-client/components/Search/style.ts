...
export const Input = styled.input<InputProps>`
  ...
  background-color: ${(p) =>
    p.backgroundColor ? p.theme.colors.grey[p.backgroundColor] : p.theme.colors.grey[5]};
  ...
  ${(p) =>
    !p.hideBorder &&
    `
      border: 1px solid ${p.theme.colors.grey[30]};
...
export const Result = styled.div`
  ...
  box-shadow: -1px 1px 6px ${(p) => p.theme.colors.grey[5]}, 1px 1px 6px ${(p) => p.theme.colors.grey[5]};
`;
