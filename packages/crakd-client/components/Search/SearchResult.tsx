...
import { TournamentIcon } from '../ui/icons';
                ...
                items.map((item) => {
                    ...
                    return (
                        ...
                        >
                            {!onlyUsers && (
                                <SearchIcon>
                                    {isUserResult ? <Avatar image={item.image} size={0.8} /> : <TournamentIcon width="16" />}
                                </SearchIcon>
                            )}
                            <>
                                {isUserResult ? (
                            ...
                            {!onlyUsers && <SearchType>{isUserResult ? 'User' : 'Tournament'}</SearchType>}
                        </Item>
                    );
                })
            )}
